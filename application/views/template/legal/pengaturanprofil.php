                            ...
                            <div class=" form-row mx-auto centered" style="border-top:1px solid rgba(0,0,0,0.1);">
                                <div class="col-xs-12 col-sm-4 mx-auto mt-5">
                                    ...
                                    <div class="alert alert-danger">
                                        <?php echo $this->session->flashdata('notm');?></span>
                                    </div>
                                    <?php endif?>
                                    <?php if($this->session->flashdata('scc')):?>
                                    <div class="alert alert-success">
                                        <?php echo $this->session->flashdata('scc');?>
                                    </div>
                                    <?php endif?>
                                    <?php if($this->session->flashdata('sccm')):?>
                                    <div class="alert alert-success">
                                        <?php echo $this->session->flashdata('sccm');?>
                                    </div>
                                    <?php endif?>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo base_url() ;?>Pengaturanprofil/edit_email" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="modal fade" id="editpassword" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo base_url() ;?>Pengaturanprofil/edit_password" enctype="multipart/form-data" method="POST">
                                                        <div class="form-group">
                                                            <div class="form-label-group">
